...
MFCLKIT_GITHUB_REF ?= $(call yml,y$$env$$MFCLKIT_GITHUB_REF,main)
...
PAR_SOURCE_STEP ?= $(call yml,y$$env$$PAR_SOURCE_STEP,)
STEPWISE_PAR_SOURCE_DIR ?= $(call yml,y$$env$$STEPWISE_PAR_SOURCE_DIR,)
STEPWISE_SINGLE_PAR_ITERATIONS ?= $(call yml,y$$env$$STEPWISE_SINGLE_PAR_ITERATIONS,)
STEPWISE_SINGLE_PAR_CONVERGENCE ?= $(call yml,y$$env$$STEPWISE_SINGLE_PAR_CONVERGENCE,)
STEPWISE_SINGLE_PAR_SWITCHES ?= $(call yml,y$$env$$STEPWISE_SINGLE_PAR_SWITCHES,)
STEPWISE_LORENZEN_M_START ?= $(call yml,y$$env$$STEPWISE_LORENZEN_M_START,)
...
local: readme
	...
	PAR_SOURCE_STEP='$(PAR_SOURCE_STEP)' \
	STEPWISE_PAR_SOURCE_DIR='$(STEPWISE_PAR_SOURCE_DIR)' \
	STEPWISE_SINGLE_PAR_ITERATIONS='$(STEPWISE_SINGLE_PAR_ITERATIONS)' \
	STEPWISE_SINGLE_PAR_CONVERGENCE='$(STEPWISE_SINGLE_PAR_CONVERGENCE)' \
	STEPWISE_SINGLE_PAR_SWITCHES='$(STEPWISE_SINGLE_PAR_SWITCHES)' \
	STEPWISE_LORENZEN_M_START='$(STEPWISE_LORENZEN_M_START)' \
...
docker: readme
	...
	docker run --rm \
	  ...
	  -e MFCLKIT_GITHUB_REF='$(MFCLKIT_GITHUB_REF)' \
	  ...
	  -e PAR_SOURCE_STEP='$(PAR_SOURCE_STEP)' \
	  -e STEPWISE_PAR_SOURCE_DIR='$(STEPWISE_PAR_SOURCE_DIR)' \
	  -e STEPWISE_SINGLE_PAR_ITERATIONS='$(STEPWISE_SINGLE_PAR_ITERATIONS)' \
	  -e STEPWISE_SINGLE_PAR_CONVERGENCE='$(STEPWISE_SINGLE_PAR_CONVERGENCE)' \
	  -e STEPWISE_SINGLE_PAR_SWITCHES='$(STEPWISE_SINGLE_PAR_SWITCHES)' \
	  -e STEPWISE_LORENZEN_M_START='$(STEPWISE_LORENZEN_M_START)' \
