...
help:
	@printf '%s\n' \
	  ...
	  'For the length-selectivity phase test branch, set BET_LENGTH_SEL_PHASE=1..11.' \
	  '' \
...
local: readme
	...
	BET_LENGTH_SEL_PHASE='$(BET_LENGTH_SEL_PHASE)' \
...
docker: readme
	...
	docker run --rm \
	  ...
	  -e BET_LENGTH_SEL_PHASE='$(BET_LENGTH_SEL_PHASE)' \
