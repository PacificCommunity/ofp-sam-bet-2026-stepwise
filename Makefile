...
help:
	@printf '%s\n' \
	  ...
	  '' \
	  '  Set PROGRAM_PATH=/home/mfcl/mfclrtmb to reproduce the native-mfcl runtime locally/Suva.' \
	  ...
	  '' \
	  'Common overrides: STEP_SELECT, RUN_MODE, INPUT_PAR, MFCL_LIVE_LOG, PROGRAM_PATH, TRIGGER_NEXT, OUTPUT_DIR.'
