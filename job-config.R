...
stepwise_run <- list(
  ...
  flow_group = "bet-2026-stepwise-s1s2-fixed-job604",
...
stepwise_models <- data.frame(
  ...
  change_axis = c(
    ...
    "effort creep with length-at-age variance s1/s2 fixed to the job 604 final-par estimates",
  ...
  job_title = c(
    ...
    "10 Tag mixing KS",
    "11 Time-varying CV",
    "12 Effort creep, s1/s2 fixed to job 604",
