...
publication methods text, DAG and caption, the 23-row configuration table, and
...
| 04 | Fixed Lorenzen M scaling | `04-FixM` | `03-Ini1007` | Fix the log-scale Lorenzen natural-mortality coefficient (`log c = -2.549`) at the 2023 diagnostic-model estimate to improve stability, as agreed at the pre-assessment workshop. | Data, structure, and other biological settings. | Carried forward. |
