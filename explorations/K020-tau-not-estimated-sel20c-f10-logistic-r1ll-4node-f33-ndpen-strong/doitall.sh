...
# Selectivity settings
  ...
  -1 61 4  # F1 LL.WEST.1: four cubic-spline coefficients
  -2 61 4  # F2 LL.EAST.1: four cubic-spline coefficients
  -3 61 4  # F3 LL.US.1: four cubic-spline coefficients
  -10 57 1  # F10 LL.ALL.5: asymptotic logistic selectivity (fish_pars 9 and 10)
...
# F33 sensitivity: retain the fitted five-node spline but strongly penalize
# any decline after Index R5 becomes its own selectivity group.
  -33 16 1          # F33 Index R5: activate non-decreasing selectivity penalty
  -33 56 100000000  # F33 Index R5: strong one-sided penalty weight (1e8)
PHASE5
