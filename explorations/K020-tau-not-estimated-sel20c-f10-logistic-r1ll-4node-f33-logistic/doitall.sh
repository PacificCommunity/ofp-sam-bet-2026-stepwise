...
# F33 sensitivity: after the regional indices are independent, replace only
# Index R5's five-node spline with MFCL's two-parameter asymptotic logistic.
  -33 57 1  # F33 Index R5: asymptotic logistic selectivity
PHASE5
