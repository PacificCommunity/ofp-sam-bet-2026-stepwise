# 23b: K=0.15 cutoff with one common tag tau

This sensitivity is an exact clone of `21-MIX015-SC22IP10Cutoff` except for
the tag-recapture tau controls added to `doitall.sh` from Phase 10 onward.

| Item | Setting |
| --- | --- |
| Scientific parent | `21-MIX015-SC22IP10Cutoff` |
| Mixing periods | SC22-IP10 K=0.15 cutoff; unchanged from the parent |
