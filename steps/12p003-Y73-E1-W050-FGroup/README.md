# 12p003-Y73-E1-W050-FGroup

Tests 73 annual OPR coefficients with a one-calendar-year endpoint and terminal-recruitment penalty weight 50. The reviewed controls are held constant across shared selectivity groups, and every case receives the same 1,000-evaluation phase; weight zero is the matched optimisation control.
...
- Terminal penalty: requested weight `50`; `parest_flag(397)=500`; final matched phase: 1,000 evaluations.
