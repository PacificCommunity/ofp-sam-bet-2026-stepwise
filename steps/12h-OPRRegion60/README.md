...
OPR step-12 sensitivity `69-01-60-60` before length-based selectivity.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/12h-OPRRegion60/model` |
...
| 2 | Applies OPR sensitivity `69-01-60-60`. |
...
| 5 | The OPR transfer uses sensitivity `69-01-60-60` with terminal end window `2`. |
