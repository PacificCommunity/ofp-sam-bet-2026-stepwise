# 09 PH/ID and domestic size-data rules
...
| Field | Value |
| --- | --- |
| Step folder | `steps/09-SizeDataQC/model` |
...
| # | Change |
| --- | --- |
| 1 | Apply the agreed PH/ID and domestic mixed-gear size-data rules. |
...
| 6 | Scientific parent: '08-DataTo2024'. |
...
| `Step-specific change` | Apply the agreed PH/ID and domestic mixed-gear size-data rules. | All previously selected controls; no OPR or length-bin selectivity. |
