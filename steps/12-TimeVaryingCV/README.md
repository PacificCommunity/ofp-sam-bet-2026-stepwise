...
| # | Change |
| --- | --- |
| 1 | Apply normalized time-varying CPUE relative-variance multipliers to F29-F33 while retaining the Step 11 observation-error scales. |
| 2 | Scientific parent: '11-RegionalCPUE'. |
...
| `Step-specific change` | Apply normalized time-varying CPUE relative-variance multipliers to F29-F33 while retaining the Step 11 observation-error scales. | All previously selected controls; no OPR or length-bin selectivity. |
