...
Tests the fully saturated annual basis conditional on a three-year endpoint in every OPR component. Raises both spatial OPR blocks together to test whether added spatial flexibility absorbs the terminal signal.
