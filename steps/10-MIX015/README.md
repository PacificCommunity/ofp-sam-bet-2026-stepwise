...
| Field | Value |
| --- | --- |
| Step folder | `steps/10-MIX015/model` |
...
| # | Change |
| --- | --- |
| 1 | Copy only MIX015 tag mixing periods into column 1 while retaining tag_flags(:,2)=0. |
| 2 | Scientific parent: '09c-SUB075'. |
...
| `doitall.sh` | Copy only MIX015 tag mixing periods into column 1 while retaining tag_flags(:,2)=0. | All previously selected controls; no OPR or length-bin selectivity. |
