...
Keeps the fully saturated annual effect free while applying a two-year endpoint only to non-annual components. Reduces only the regional block, isolating it from the season-by-region interaction.
