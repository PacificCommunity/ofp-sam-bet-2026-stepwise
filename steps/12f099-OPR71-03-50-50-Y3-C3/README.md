...
Tests the fully saturated annual basis conditional on a three-year endpoint in every OPR component. Provides an intermediate seasonal count between the rank-1 and seasonal-5 screens.
