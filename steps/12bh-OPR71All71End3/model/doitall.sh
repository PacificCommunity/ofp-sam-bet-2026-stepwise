...
# 12bh OPR: all effects saturated conditional on three-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 217 71   # seasonal OPR coefficient count (polynomial degree = count - 1)
  1 216 71  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 71  # season-by-region OPR coefficient count (polynomial degree = count - 1)
