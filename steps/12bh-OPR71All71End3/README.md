...
Tests the all-effect saturation ceiling under a three-year endpoint.
...
| Terminal treatment | `155=71`, `217=71`, `216=71`, `218=71`; `202/203=3/0`; `210/211=3/0`; `212/213=3/0`; `214/215=3/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 3 is 71. |
...
```text
1 155 71   1 217 71   1 216 71   1 218 71
