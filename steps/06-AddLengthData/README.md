...
| Field | Value |
| --- | --- |
| Step folder | `steps/06-AddLengthData/model` |
...
| 2 | Scientific parent: '05-ConvertToLength'. |
...
| `doitall.sh` | Add the additional length-composition data. | All previously selected controls; no OPR or length-bin selectivity. |
