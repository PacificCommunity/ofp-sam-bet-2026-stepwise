# 12p082-C2-TagRR60P0121

Keeps the externally derived reporting-rate target at 0.52015 and estimates one parameter for release group 60 pooled across fisheries 25-28. The Gaussian prior penalty is 12.13 (SD 0.203). This is a prior-precision sensitivity; the campaign-level grouping remains the cleaner final-model candidate, and selection cannot be based on recruitment shape alone.
...
- Tag-release deletion: `none`; 2021 reporting-rate scope: `group60`; target 0.52015; penalty 12.13.
