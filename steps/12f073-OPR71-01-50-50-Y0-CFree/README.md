...
Provides a lower near-saturated comparison with no multi-year endpoint treatment. Uses the current Step 12 rank-1 component profile as the within-branch reference.
...
```text
1 155 71   1 217 1   1 216 50   1 218 50
