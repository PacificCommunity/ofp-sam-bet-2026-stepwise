# 12p027-Y71-E0-W000-FGroup

Uses 71 annual OPR coefficients with no annual terminal endpoint and component endpoint flags set to -1. This is the direct no-endpoint control; the terminal-recruitment penalty is necessarily off.

## Controls

- OPR profile: `71-01-50-50`; terminal window: no multi-year annual endpoint; component endpoint: `-1`.
