...
Tests the fully saturated annual basis conditional on a two-year endpoint in every OPR component. Reduces only the regional block, isolating it from the season-by-region interaction.
