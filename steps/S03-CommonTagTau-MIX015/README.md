...
Retain the F33 asymptotic selectivity model and estimate one common negative-binomial tag-overdispersion parameter across active tag-recapture fisheries F1-F28.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/S03-CommonTagTau-MIX015/model` |
...
| # | Change |
| --- | --- |
| 1 | Retain the F33 asymptotic selectivity model and estimate one common negative-binomial tag-overdispersion parameter across active tag-recapture fisheries F1-F28. |
...
| 5 | F2/F3 and F7/F9 extraction selectivity sharing, independent F29-F33 selectivities, F33 logistic form, DM G8 Nmax25, SC22-IP10 K=0.15 mixing periods, reporting-rate priors, CPUE controls and data are unchanged. |
...
| 7 | Scientific parent: 'S02-F33Asymptotic-MIX015'. |
...
| `Step-specific change` | Retain the F33 asymptotic selectivity model and estimate one common negative-binomial tag-overdispersion parameter across active tag-recapture fisheries F1-F28. | All previously selected controls; no OPR or length-bin selectivity. |
