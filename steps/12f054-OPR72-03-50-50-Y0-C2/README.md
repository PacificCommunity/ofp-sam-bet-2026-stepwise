...
Separates a near-saturated free annual effect from a two-year non-annual endpoint. Provides an intermediate seasonal count between the rank-1 and seasonal-5 screens.
