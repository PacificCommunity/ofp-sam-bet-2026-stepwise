...
# Likelihood component settings
  ...
  1 141 11  # Dirichlet-multinomial LF likelihood without random effects
...
# Filter out comps with input samples less than 50
  1 311 1  # retain LF preprocessing gate
...
# MFCL 2.2.2.0 growth variance fix
  ...
  1 320 5  # DM LF tail compression retains at least five class intervals
  1 342 25  # final DM Nmax25
