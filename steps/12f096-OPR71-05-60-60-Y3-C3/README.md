...
Tests the fully saturated annual basis conditional on a three-year endpoint in every OPR component. Combines the seasonal-5 alternative with the higher spatial-complexity screen.
