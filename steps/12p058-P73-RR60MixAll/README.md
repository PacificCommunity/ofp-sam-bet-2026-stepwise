...
Estimates a separate reporting rate only for release group 60 at target 0.52015 and penalty 485.2 while applying tag_flags(:,2)=1 to every release. Comparison with the campaign grouping diagnoses reporting-rate/recruitment confounding.
