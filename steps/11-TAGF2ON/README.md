...
| Field | Value |
| --- | --- |
| Step folder | `steps/11-TAGF2ON/model` |
...
| # | Change |
| --- | --- |
| 1 | Change only tag_flags(:,2) from 0 to 1. |
| 2 | Scientific parent: '10-MIX015'. |
...
| `doitall.sh` | Change only tag_flags(:,2) from 0 to 1. | All previously selected controls; no OPR or length-bin selectivity. |
