...
Tests one fewer annual coefficient than full saturation with all OPR components terminally free. Combines the seasonal-5 alternative with a balanced spatial reduction.
...
```text
1 155 72   1 217 5   1 216 40   1 218 40
