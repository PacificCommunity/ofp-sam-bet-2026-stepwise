...
# Set Lorenzen M
  ...
  1 121 1    # estimate the Lorenzen natural-mortality log-intercept; retain the incoming length slope
...
$program_path bet.frq 09.par 10.par -file - <<PHASE10
  ...
  1 121 1    # retain estimation of the Lorenzen natural-mortality log-intercept
PHASE10
