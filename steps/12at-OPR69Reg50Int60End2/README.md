...
Separates interaction complexity from the regional block in the high-interaction direction.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=60`; `202/203=2/0`; `210/211=2/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 2 is 72. |
...
```text
1 155 69   1 217 1   1 216 50   1 218 60
