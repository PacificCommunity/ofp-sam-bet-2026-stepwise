...
# 12cb OPR: rank-1 region block with minimal interaction block and three-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 218 1  # season-by-region OPR coefficient count (polynomial degree = count - 1)
