...
Tests an intermediate high-season model with fewer regional and interaction coefficients than the screening 05-50-50 setting.
...
| Terminal treatment | `155=69`, `217=5`, `216=40`, `218=40`; `202/203=2/0`; `210/211=2/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 2 is 72. |
...
```text
1 155 69   1 217 5   1 216 40   1 218 40
