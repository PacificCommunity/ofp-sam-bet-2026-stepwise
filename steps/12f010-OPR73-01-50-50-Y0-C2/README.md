...
Keeps the fully saturated annual effect free while applying a two-year endpoint only to non-annual components. Uses the current Step 12 rank-1 component profile as the within-branch reference.
