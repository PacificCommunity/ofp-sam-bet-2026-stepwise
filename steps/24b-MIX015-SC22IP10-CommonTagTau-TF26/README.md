# 24b: Step 23b with MFCL 2.6

This executable sensitivity is an exact clone of
`23b-MIX015-SC22IP10-CommonTagTau`, apart from the pinned
runtime/executable and the regional-scaling header required by that
executable.

| Item | Setting |
| --- | --- |
| Scientific parent | `23b-MIX015-SC22IP10-CommonTagTau` |
...
| Mixing periods | SC22-IP10 K=0.15 cutoff, unchanged |
...
byte-identical to Step 23b. The 20-by-5 regional-scaling values,
