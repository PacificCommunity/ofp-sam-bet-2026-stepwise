...
Tests the absolute 73-year saturation boundary with no multi-year endpoint tie in any OPR component. Adds seasonal flexibility while holding both spatial blocks at the Step 12 values.
...
```text
1 155 73   1 217 5   1 216 50   1 218 50
