# 14 New conditional age-at-length data
...
| Field | Value |
| --- | --- |
| Step folder | `steps/14-NewAgeData/model` |
...
| # | Change |
| --- | --- |
| 1 | Add the new conditional age-at-length data with a weighting factor of 0.75 from the 2023 BET assessment. |
| 2 | Scientific parent: '13-CPUEErrorCalibration'. |
...
| `.age_length` | bet.2026.age_length |
...
| `Step-specific change` | Add the new conditional age-at-length data with a weighting factor of 0.75 from the 2023 BET assessment. | All previously selected controls; no OPR or length-bin selectivity. |
