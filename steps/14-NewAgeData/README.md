...
| # | Change |
| --- | --- |
| 1 | Add the new 2026 age data using the common BASE075 weighting as the reference state. |
...
| `Step-specific change` | Add the new 2026 age data using the common BASE075 weighting as the reference state. | All previously selected controls; no OPR or length-bin selectivity. |
