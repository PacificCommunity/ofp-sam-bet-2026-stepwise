...
Keeps the fully saturated annual effect free while testing a four-year non-annual endpoint treatment. Raises both spatial OPR blocks together to test whether added spatial flexibility absorbs the terminal signal.
...
1 202 0   1 203 0   1 210 4   1 211 0
1 212 4   1 213 0   1 214 4   1 215 0
```
