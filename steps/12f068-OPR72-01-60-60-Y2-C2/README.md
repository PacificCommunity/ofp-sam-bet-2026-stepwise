...
Tests the fully saturated annual basis conditional on a two-year endpoint in every OPR component. Raises both spatial OPR blocks together to test whether added spatial flexibility absorbs the terminal signal.
...
| Terminal treatment | `155=72`, `217=1`, `216=60`, `218=60`; `202/203=2/0`; `210/211=2/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the effective one-point beginning endpoint, MFCL's annual coefficient ceiling is `74 - max(1, end window)`: end window 2 therefore permits at most 72 coefficients. A count of 74 is invalid even with end0. |
