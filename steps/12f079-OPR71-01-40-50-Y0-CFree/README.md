...
Provides a lower near-saturated comparison with no multi-year endpoint treatment. Reduces only the regional block, isolating it from the season-by-region interaction.
