...
Scales only the tag likelihood to 0.100 with parest_flag(177)=100. Reporting-rate priors remain active, so this is a dose-response diagnostic rather than a literal no-tag model.
