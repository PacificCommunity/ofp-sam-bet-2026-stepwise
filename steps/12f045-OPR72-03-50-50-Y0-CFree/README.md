...
Tests one fewer annual coefficient than full saturation with all OPR components terminally free. Provides an intermediate seasonal count between the rank-1 and seasonal-5 screens.
...
```text
1 155 72   1 217 3   1 216 50   1 218 50
