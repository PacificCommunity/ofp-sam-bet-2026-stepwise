...
Retain the K=0.05 grouped-selectivity final DM model and set parest flag 177 to 500, multiplying the tag-return likelihood by 0.50.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/22c-R1F2F3F29Shared-MIX005-TAGW500/model` |
...
| # | Change |
| --- | --- |
| 1 | Retain the K=0.05 grouped-selectivity final DM model and set parest flag 177 to 500, multiplying the tag-return likelihood by 0.50. |
| 2 | Selectivity source: Job 15984, repository commit d9fd5377abd5ba6aac5aee1b56ec54a9d9d4fc12. |
| 3 | Mixing-period source: SC22-IP10 K=0.05. |
...
| 5 | Scientific parent: '21b-R1F2F3F29Shared-MIX005'. |
...
| `Step-specific change` | Retain the K=0.05 grouped-selectivity final DM model and set parest flag 177 to 500, multiplying the tag-return likelihood by 0.50. | All previously selected controls; no OPR or length-bin selectivity. |
...
|  7 | Parest flag 177 is 500, multiplying the tag-return likelihood by 0.50; release-group reporting-rate priors are retained at their configured weights. |
