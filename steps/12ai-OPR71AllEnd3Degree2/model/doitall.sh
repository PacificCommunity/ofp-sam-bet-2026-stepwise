...
# 12ai OPR: 71 annual coefficients with three-year endpoint and retained linear terms.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 155 71  # annual OPR coefficient count (polynomial degree = count - 1)
  ...
  1 203 2   # year effect: linear term remains free; quadratic and higher terms are flat
  1 210 3   # region effect: last 3 real years share the high-order endpoint basis
  1 211 2   # region effect: linear term remains free; quadratic and higher terms are flat
  1 212 3   # season effect: last 3 real years share the high-order endpoint basis
  1 213 2   # season effect: linear term remains free; quadratic and higher terms are flat
  1 214 3   # season-by-region effect: last 3 real years share the high-order endpoint basis
  1 215 2   # season-by-region effect: linear term remains free; quadratic and higher terms are flat
