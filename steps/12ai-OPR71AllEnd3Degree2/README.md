...
Separates the three-year saturation ceiling from the default all-high-order-term endpoint flattening.
...
| Terminal treatment | `155=71`, `217=1`, `216=50`, `218=50`; `202/203=3/2`; `210/211=3/2`; `212/213=3/2`; `214/215=3/2`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 3 is 71. |
