...
# 12f078 OPR 71-05-60-60; annual end0; component endFree.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 217 5   # seasonal OPR coefficient count (polynomial degree = count - 1)
  1 216 60  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 60  # season-by-region OPR coefficient count (polynomial degree = count - 1)
