...
Provides a lower near-saturated comparison with no multi-year endpoint treatment. Combines the seasonal-5 alternative with the higher spatial-complexity screen.
...
```text
1 155 71   1 217 5   1 216 60   1 218 60
