...
Tests one fewer annual coefficient than full saturation with all OPR components terminally free. Raises both spatial OPR blocks together to test whether added spatial flexibility absorbs the terminal signal.
...
```text
1 155 72   1 217 1   1 216 60   1 218 60
