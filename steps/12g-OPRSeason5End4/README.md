...
OPR step-12 sensitivity `69-05-50-50 end4` before length-based selectivity.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/12g-OPRSeason5End4/model` |
...
| 2 | Applies OPR sensitivity `69-05-50-50 end4`. |
...
| 3 | `1 155 69`, `1 217 5`, `1 216 50`, and `1 218 50` set the OPR year, season, region, and region-season effects. |
...
| 5 | The OPR transfer uses sensitivity `69-05-50-50 end4` with terminal end window `4`. |
