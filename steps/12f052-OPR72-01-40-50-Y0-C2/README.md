...
Separates a near-saturated free annual effect from a two-year non-annual endpoint. Reduces only the regional block, isolating it from the season-by-region interaction.
