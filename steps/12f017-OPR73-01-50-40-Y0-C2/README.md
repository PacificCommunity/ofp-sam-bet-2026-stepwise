...
Keeps the fully saturated annual effect free while applying a two-year endpoint only to non-annual components. Reduces only the season-by-region block, isolating the main Hessian burden.
