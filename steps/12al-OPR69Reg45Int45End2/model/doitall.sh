...
# 12al OPR: intermediate-low regional and interaction complexity with two-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 202 2   # year effect: last 2 real years share the high-order endpoint basis
