# 24c: Step 23c with MFCL 2.6

This executable sensitivity is an exact clone of
`23c-MIX020-MeanOverPeriod-CommonTagTau`, apart from the pinned
runtime/executable and the regional-scaling header required by that
executable.

| Item | Setting |
| --- | --- |
| Scientific parent | `23c-MIX020-MeanOverPeriod-CommonTagTau` |
...
| Mixing periods | Main-branch K=0.2 mean over period, unchanged |
...
byte-identical to Step 23c. The 20-by-5 regional-scaling values,
