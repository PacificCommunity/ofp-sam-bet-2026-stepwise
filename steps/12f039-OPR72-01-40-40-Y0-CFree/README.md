...
Tests one fewer annual coefficient than full saturation with all OPR components terminally free. Reduces both spatial OPR blocks together to test Hessian conditioning and fit loss.
...
```text
1 155 72   1 217 1   1 216 40   1 218 40
