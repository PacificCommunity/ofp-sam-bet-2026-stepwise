...
# 12f039 OPR 72-01-40-40; annual end0; component endFree.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 155 72  # annual OPR coefficient count (polynomial degree = count - 1)
  1 217 1   # seasonal OPR coefficient count (polynomial degree = count - 1)
  1 216 40  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 40  # season-by-region OPR coefficient count (polynomial degree = count - 1)
