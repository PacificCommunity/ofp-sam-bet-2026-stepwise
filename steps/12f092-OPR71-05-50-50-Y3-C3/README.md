...
Tests the fully saturated annual basis conditional on a three-year endpoint in every OPR component. Adds seasonal flexibility while holding both spatial blocks at the Step 12 values.
