...
Keeps the fully saturated annual effect free while applying a two-year endpoint only to non-annual components. Reduces both spatial OPR blocks together to test Hessian conditioning and fit loss.
