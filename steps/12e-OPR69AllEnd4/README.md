...
Tests a longer all-component endpoint while retaining one annual degree below the constrained saturation ceiling.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=50`; `202/203=4/0`; `210/211=4/0`; `212/213=4/0`; `214/215=4/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 4 is 70. |
