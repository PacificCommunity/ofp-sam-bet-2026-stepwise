...
Tests the absolute 73-year saturation boundary with no multi-year endpoint tie in any OPR component. Reduces both spatial OPR blocks together to test Hessian conditioning and fit loss.
...
```text
1 155 73   1 217 1   1 216 40   1 218 40
