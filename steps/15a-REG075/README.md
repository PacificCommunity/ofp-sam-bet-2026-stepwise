# 15a Regional age weighting

Apply the exact heterogeneous REG075 composition-weighting alternative.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/15a-REG075/model` |
...
| # | Change |
| --- | --- |
| 1 | Apply the exact heterogeneous REG075 composition-weighting alternative. |
...
| `Step-specific change` | Apply the exact heterogeneous REG075 composition-weighting alternative. | All previously selected controls; no OPR or length-bin selectivity. |
