...
Provides a lower near-saturated comparison with no multi-year endpoint treatment. Combines the seasonal-5 alternative with a balanced spatial reduction.
...
```text
1 155 71   1 217 5   1 216 40   1 218 40
