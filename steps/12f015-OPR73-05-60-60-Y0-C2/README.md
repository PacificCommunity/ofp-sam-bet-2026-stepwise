...
Keeps the fully saturated annual effect free while applying a two-year endpoint only to non-annual components. Combines the seasonal-5 alternative with the higher spatial-complexity screen.
