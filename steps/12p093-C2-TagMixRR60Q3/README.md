# 12p093-C2-TagMixRR60Q3

Sets tag_flags(60,2)=1 and changes the dominant 2021 release group's imputed mixing period from 1 to 3 quarters. Together with the one-quarter TagMixRR60 case, this tests pre-mixing imputation uncertainty without suppressing late recaptures.
...
- Mixing-period reporting treatment: `group60`; dominant 2021 mixing period override: `3 quarters`.
