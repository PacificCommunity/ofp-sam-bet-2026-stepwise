...
Separates a near-saturated free annual effect from a stronger three-year non-annual endpoint. Reduces only the regional block, isolating it from the season-by-region interaction.
