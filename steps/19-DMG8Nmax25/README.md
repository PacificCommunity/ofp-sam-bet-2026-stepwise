...
|  6 | The Job 15062 flexible-selectivity specification sets flag 16 to 0 for all 14 applicable fisheries, so the dome/old-age-tail form penalty is off. |
...
|  9 | G8PSSET DM likelihood with effective-sample-size upper asymptote Nmax=25; grouped fish_pars(22) fixed at 7 as in Job 18518. |
