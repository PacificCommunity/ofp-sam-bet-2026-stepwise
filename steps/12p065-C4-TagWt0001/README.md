...
Scales only the tag likelihood to 0.001 with parest_flag(177)=1. Reporting-rate priors remain active, so this is a dose-response diagnostic rather than a literal no-tag model.
...
- Tag likelihood scalar flag: `parest_flag(177)=1`.
