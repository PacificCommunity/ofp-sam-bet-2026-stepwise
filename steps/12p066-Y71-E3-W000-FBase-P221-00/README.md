# 12p066-Y71-E3-W000-FBase-P221-00

Matched compatibility control for the supplied OPR71/end3 setup, with parest_flag(221)=0. Public ongoing-dev treats flag 221 as obsolete; compare only with the paired flag-71 row.
