...
# Terminal-recruitment controls are parameters of the complete standard path,
# not merely a final-refit switch. Scenario doitall wrappers export these two
# optional values before invoking this common script. OPR scenarios leave them
# unset and retain the Step-11 Fix6 baseline until their OPR conversion.
standard_p398=${STANDARD_P398:-1}
standard_p400=${STANDARD_P400:-6}
case "$standard_p398:$standard_p400" in
  *[!0-9:]*|:) 
    echo "STANDARD_P398 and STANDARD_P400 must be non-negative integers." >&2
    exit 1
    ;;
esac
echo "Standard terminal settings: pf398=$standard_p398 pf400=$standard_p400"
...
# Recruitment and initial population settings
  ...
  1 400 $standard_p400  # final recruitment deviates set to zero
