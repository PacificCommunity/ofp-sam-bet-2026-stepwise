...
| Field | Value |
| --- | --- |
| Step folder | `steps/08-DataTo2024/model` |
...
| # | Change |
| --- | --- |
| 1 | Extend data through 2024 except CAAL while retaining the same reporting-rate specification. |
| 2 | Scientific parent: '07-AddLengthData'. |
...
| `Step-specific change` | Extend data through 2024 except CAAL while retaining the same reporting-rate specification. | All previously selected controls; no OPR or length-bin selectivity. |
