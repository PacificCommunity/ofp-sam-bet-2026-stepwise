...
| `doitall.sh` | Add regional CPUE data and likelihood plus the REGW100 regional-scaling penalty. | All previously selected controls; no OPR or length-bin selectivity. |
