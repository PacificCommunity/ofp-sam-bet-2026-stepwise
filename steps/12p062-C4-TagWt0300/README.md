...
Scales only the tag likelihood to 0.300 with parest_flag(177)=300. Reporting-rate priors remain active, so this is a dose-response diagnostic rather than a literal no-tag model.
