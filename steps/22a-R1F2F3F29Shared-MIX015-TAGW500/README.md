...
Retain the K=0.15 grouped-selectivity final DM model and set parest flag 177 to 500, multiplying the tag-return likelihood by 0.50.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/22a-R1F2F3F29Shared-MIX015-TAGW500/model` |
...
| # | Change |
| --- | --- |
| 1 | Retain the K=0.15 grouped-selectivity final DM model and set parest flag 177 to 500, multiplying the tag-return likelihood by 0.50. |
...
| `Step-specific change` | Retain the K=0.15 grouped-selectivity final DM model and set parest flag 177 to 500, multiplying the tag-return likelihood by 0.50. | All previously selected controls; no OPR or length-bin selectivity. |
