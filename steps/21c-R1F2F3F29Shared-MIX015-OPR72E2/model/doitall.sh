...
opr_terminal_evaluations=${BET_OPR_TERMINAL_EVALUATIONS:-20000}
case "$opr_terminal_evaluations" in
  ''|*[!0-9]*) echo "BET_OPR_TERMINAL_EVALUATIONS must be a positive integer." >&2; exit 1 ;;
esac
if [ "$opr_terminal_evaluations" -le 0 ]; then
  echo "BET_OPR_TERMINAL_EVALUATIONS must be a positive integer." >&2
  exit 1
fi
echo "OPR terminal refinement evaluations: $opr_terminal_evaluations"
...
# Staged run 1 uses 29 contiguous groups: F1-F28 use groups 1-28; F29-F33 initially share group 29.
  -1 24 1  # F1 Job 15984 selectivity group
  -2 24 2  # F2 Job 15984 selectivity group (shared Region 1 curve)
  -3 24 2  # F3 Job 15984 selectivity group (shared Region 1 curve)
  -4 24 3  # F4 Job 15984 selectivity group
  -5 24 4  # F5 Job 15984 selectivity group
  -6 24 5  # F6 Job 15984 selectivity group
  -7 24 6  # F7 Job 15984 selectivity group
  -8 24 7  # F8 Job 15984 selectivity group
  -9 24 8  # F9 Job 15984 selectivity group
  -10 24 9  # F10 Job 15984 selectivity group
  -11 24 10  # F11 Job 15984 selectivity group
  -12 24 11  # F12 Job 15984 selectivity group
  -13 24 12  # F13 Job 15984 selectivity group
  -14 24 13  # F14 Job 15984 selectivity group
  -15 24 14  # F15 Job 15984 selectivity group
  -16 24 15  # F16 Job 15984 selectivity group
  -17 24 16  # F17 Job 15984 selectivity group
  -18 24 17  # F18 Job 15984 selectivity group
  -19 24 18  # F19 Job 15984 selectivity group
  -20 24 19  # F20 Job 15984 selectivity group
  -21 24 20  # F21 Job 15984 selectivity group
  -22 24 21  # F22 Job 15984 selectivity group
  -23 24 22  # F23 Job 15984 selectivity group
  -24 24 23  # F24 Job 15984 selectivity group
  -25 24 24  # F25 Job 15984 selectivity group
  -26 24 25  # F26 Job 15984 selectivity group
  -27 24 26  # F27 Job 15984 selectivity group
  -28 24 27  # F28 Job 15984 selectivity group
  -29 24 2  # F29 Job 15984 selectivity group (shared Region 1 curve)
  -30 24 3  # F30 Job 15984 selectivity group
  -31 24 6  # F31 Job 15984 selectivity group
  -32 24 7  # F32 Job 15984 selectivity group
  -33 24 28  # F33 Job 15984 selectivity group
...
# MFCL 2.2.2.0 growth variance fix
  ...
  -1 61 4  # F1 Job 15984 four-node cubic-spline selectivity
  -2 61 4  # F2 Job 15984 four-node cubic-spline selectivity
  -3 61 4  # F3 Job 15984 four-node cubic-spline selectivity
  -5 61 4  # F5 Job 15984 four-node cubic-spline selectivity
  -29 61 4  # F29 Job 15984 four-node cubic-spline selectivity
  -33 61 4  # F33 Job 15984 four-node cubic-spline selectivity
...
# Orthogonal-polynomial recruitment (OPR), adapted to the 1952-2024 model span.
# The 72-01-50-50 basis retains the reviewed BET rank structure; E2 constrains
# the final two calendar years. The terminal penalty is added only in Phase 11.
  1 149 0   # turn off the standard recruitment-deviation penalty
  1 398 0   # turn off the arithmetic-mean terminal fixed-recruitment option
  1 400 0   # clear the fixed terminal recruitment-deviation block
  2 177 0   # turn off legacy total-population scaling
  2 32 0    # turn off the standard overall-population scaling parameter
  2 113 0   # keep initial-population scaling off during OPR conversion
  1 155 72  # OPR year effect
  1 221 0   # obsolete compatibility control; no independent OPR effect
  1 217 1   # OPR season effect
  1 216 50  # OPR region effect
  1 218 50  # OPR region-season interaction
  1 202 2   # E2: terminal window of two calendar years
  1 203 0   # no separate year-effect end-degree override
  1 210 0   # region end window inherits flag 202
  1 211 0   # no separate region-effect end-degree override
  1 212 0   # season end window inherits flag 202
  1 213 0   # no separate season-effect end-degree override
  1 214 0   # interaction end window inherits flag 202
  1 215 0   # no separate interaction end-degree override
  1 397 0   # fit the base OPR before adding the terminal penalty
  2 30 1    # activate the OPR polynomial coefficients
  2 70 0    # turn off standard regional recruitment time-series deviations
  2 71 0    # turn off regional recruitment-distribution deviations
  2 178 0   # turn off the regional recruitment sum-product constraint
...
$program_path bet.frq 04.par 05.par -file - <<PHASE5
  -100000 1 0  # keep standard regional recruitment distribution off under OPR
  -100000 2 0
  -100000 3 0
  -100000 4 0
  -100000 5 0
...
# ----------
#  PHASE 11 - OPR terminal-recruitment refinement
# ----------

$program_path bet.frq 10.par 11.par -file - <<PHASE11
  1 155 72  # OPR year effect
  1 221 0   # obsolete compatibility control
  1 217 1   # OPR season effect
  1 216 50  # OPR region effect
  1 218 50  # OPR region-season interaction
  1 202 2   # E2 terminal window
  1 203 0
  1 210 0
  1 211 0
  1 212 0
  ...
  1 214 0
  1 215 0
  1 397 100  # terminal recruitment penalty; MFCL coefficient = flag / 10
  1 1 $opr_terminal_evaluations
  1 50 $phase10_11_convergence  # convergence criterion; stepwise default -4 (MGC target 1e-4)
