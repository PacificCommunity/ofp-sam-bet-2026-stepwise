# 12p061-P73-TagGammaRob

Uses robust binned gamma with a one-recapture censor and 0.05 mixture fraction. This is a targeted outlier sensitivity and its objective is not directly comparable with negative-binomial cases.
...
- Tag observation model: `robust_binned_gamma`; estimate pooled dispersion: `true`.
