...
Tests the fully saturated annual basis conditional on a two-year endpoint in every OPR component. Reduces both spatial OPR blocks together to test Hessian conditioning and fit loss.
