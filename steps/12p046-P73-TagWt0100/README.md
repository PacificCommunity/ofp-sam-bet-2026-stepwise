# 12p046-P73-TagWt0100

Scales only the tag likelihood to 0.10 with parest_flag(177)=100 while retaining reporting-rate priors. The three-point response tests whether the recent recruitment signal changes continuously with tag influence.
...
- Tag likelihood scalar flag: `parest_flag(177)=100`.
