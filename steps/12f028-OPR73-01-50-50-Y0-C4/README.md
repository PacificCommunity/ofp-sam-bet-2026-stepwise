...
Keeps the fully saturated annual effect free while testing a four-year non-annual endpoint treatment. Uses the current Step 12 rank-1 component profile as the within-branch reference.
