...
| Field | Value |
| --- | --- |
| Step folder | `steps/17-MIX015/model` |
...
| `.ini` | rrpttp26 reporting-rate matrices; bet.2026.mix-0.15.ini copied only into tag_flags(:,1); tag_flags(:,2)=0 | All unlisted INI fields and cumulative RR/tag controls. |
