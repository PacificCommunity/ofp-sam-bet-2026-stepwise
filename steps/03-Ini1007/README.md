...
| Field | Value |
| --- | --- |
| Step folder | `steps/03-Ini1007/model` |
...
| # | Change |
| --- | --- |
| 1 | Inherits the diagnostic-side 2023 assessment replication model from `02-NewExe1003`. |
...
| File | Source / note |
| --- | --- |
| `.frq` | `steps/02-NewExe1003/model/bet.frq` |
| `.ini` | `steps/02-NewExe1003/model/bet.ini`; set ini version to 1007; inserted MFCL 1007 tag-control rows for 118 release groups with 2 mixing periods; inserted zero tag shed-rate vector for 118 release groups; inserted MFCL 1007 total-population scalar default 25; inserted MFCL 1007 Richards growth parameter default 0 |
| `.tag` | `steps/02-NewExe1003/model/bet.tag` |
| `.age_length` | `steps/02-NewExe1003/model/bet.age_length` |
...
| `.frq/.tag/.age_length` | No generated edit. | Inherited from `02-NewExe1003`. |
...
| # | Check |
| --- | --- |
| 1 | Compare directly with 02-NewExe1003 to isolate this substep's change. |
