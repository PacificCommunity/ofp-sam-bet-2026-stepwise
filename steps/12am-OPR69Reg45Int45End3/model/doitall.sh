...
# 12am OPR: intermediate-low regional and interaction complexity with three-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 216 45  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 45  # season-by-region OPR coefficient count (polynomial degree = count - 1)
