...
Tests the smallest all-component extension that visibly suppresses the spike in the earlier screen.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=50`; `202/203=3/0`; `210/211=3/0`; `212/213=3/0`; `214/215=3/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 3 is 71. |
