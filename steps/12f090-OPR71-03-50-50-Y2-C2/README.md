...
Tests 71 annual coefficients under the same two-year endpoint as the saturated 72/end2 case. Provides an intermediate seasonal count between the rank-1 and seasonal-5 screens.
