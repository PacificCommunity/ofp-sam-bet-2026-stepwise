...
| 3 | Held constant: the Step 19 data, biology, fleet-specific selectivity with form penalties off, CPUE, tag, and all non-DOM composition settings. |
...
| `Step-specific change` | Apply divisor 200 only to the low-quality, previously unreweighted DOM F21-F23 length compositions. | All previously selected controls; no OPR or length-bin selectivity. |
