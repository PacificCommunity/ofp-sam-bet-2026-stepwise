...
Tests the fully saturated 73-year OPR envelope with one-point endpoints. It is intentionally a high-flexibility boundary model, not a preferred production candidate.
...
| Terminal treatment | `155=73`, `217=73`, `216=73`, `218=73`; `202/203=0/0`; `210/211=-1/0`; `212/213=-1/0`; `214/215=-1/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 0 is 73 (MFCL normalizes zero to a one-point, unpooled endpoint). |
...
```text
1 155 73   1 217 73   1 216 73   1 218 73
