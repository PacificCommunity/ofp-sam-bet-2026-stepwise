# 12p086-C3-TagRR60P0485

Keeps the externally derived reporting-rate target at 0.52015 and estimates one parameter for release group 60 pooled across fisheries 25-28. The Gaussian prior penalty is 48.52 (SD 0.102). This is a prior-precision sensitivity; the campaign-level grouping remains the cleaner final-model candidate, and selection cannot be based on recruitment shape alone.
...
- Tag-release deletion: `none`; 2021 reporting-rate scope: `group60`; target 0.52015; penalty 48.52.
