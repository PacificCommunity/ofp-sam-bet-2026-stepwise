...
Tests one fewer annual coefficient than full saturation with all OPR components terminally free. Reduces only the regional block, isolating it from the season-by-region interaction.
...
```text
1 155 72   1 217 1   1 216 40   1 218 50
