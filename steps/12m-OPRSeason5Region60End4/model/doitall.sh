...
# OPR step-12 sensitivity: 69-05-60-60 end4; terminal end window 4.
  ...
  1 217 5   # orthogonal polynomial recruitment - season effect
  1 216 60  # orthogonal polynomial recruitment - region effect
  1 218 60  # orthogonal polynomial recruitment - region-season interaction effect
  1 202 4   # OPR end window: last 4 real years use lower-degree/constant-end basis
