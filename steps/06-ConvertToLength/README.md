...
| Field | Value |
| --- | --- |
| Step folder | `steps/06-ConvertToLength/model` |
...
| # | Change |
| --- | --- |
| 1 | Replace the reweighted weight compositions with their length-frequency conversion through 2021. |
| 2 | Scientific parent: '05-NewStructure'. |
...
| `Step-specific change` | Replace the reweighted weight compositions with their length-frequency conversion through 2021. | All previously selected controls; no OPR or length-bin selectivity. |
