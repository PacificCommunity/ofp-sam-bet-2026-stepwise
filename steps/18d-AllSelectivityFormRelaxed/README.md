...
| # | Change |
| --- | --- |
| 1 | Retain the Step 16c model and remove every active fishery-specific dome/old-age-tail selectivity-form penalty. This is an all-fisheries boundary sensitivity, not a preferred model. |
...
| `doitall.sh` | Retain the Step 16c model and remove every active fishery-specific dome/old-age-tail selectivity-form penalty. This is an all-fisheries boundary sensitivity, not a preferred model. | All previously selected controls; no OPR or length-bin selectivity. |
