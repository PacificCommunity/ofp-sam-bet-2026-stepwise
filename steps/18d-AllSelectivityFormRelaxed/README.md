...
Retain the Step 17b model and remove every active fishery-specific dome/old-age-tail selectivity-form penalty. This is an all-fisheries boundary sensitivity, not a preferred model.
...
| # | Change |
| --- | --- |
| 1 | Retain the Step 17b model and remove every active fishery-specific dome/old-age-tail selectivity-form penalty. This is an all-fisheries boundary sensitivity, not a preferred model. |
| 2 | Scientific parent: '17b-DMG8Nmax25'. |
...
| `doitall.sh` | Retain the Step 17b model and remove every active fishery-specific dome/old-age-tail selectivity-form penalty. This is an all-fisheries boundary sensitivity, not a preferred model. | All previously selected controls; no OPR or length-bin selectivity. |
