# 11 Time-varying CPUE uncertainty
...
| # | Change |
| --- | --- |
| 1 | Apply normalized time-varying relative-variance multipliers to F29-F33. |
...
| 6 | Scientific parent: '10-RegionalCPUE'. |
...
| `Step-specific change` | Apply normalized time-varying relative-variance multipliers to F29-F33. | All previously selected controls; no OPR or length-bin selectivity. |
