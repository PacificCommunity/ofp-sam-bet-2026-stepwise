# 24d: Step 23d with MFCL 2.6

This executable sensitivity is an exact clone of
`23d-MIX020-MeanOverKS-CommonTagTau`, apart from the pinned
runtime/executable and the regional-scaling header required by that
executable.

| Item | Setting |
| --- | --- |
| Scientific parent | `23d-MIX020-MeanOverKS-CommonTagTau` |
...
| Mixing periods | SC22-IP10 K=0.2 mean over KS, unchanged |
...
byte-identical to Step 23d. The 20-by-5 regional-scaling values,
