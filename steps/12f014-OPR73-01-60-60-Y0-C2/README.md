...
Keeps the fully saturated annual effect free while applying a two-year endpoint only to non-annual components. Raises both spatial OPR blocks together to test whether added spatial flexibility absorbs the terminal signal.
...
1 202 0   1 203 0   1 210 2   1 211 0
