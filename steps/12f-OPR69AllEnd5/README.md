...
Tests the constrained annual-saturation case: 69 coefficients with five terminal real years pooled.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=50`; `202/203=5/0`; `210/211=5/0`; `212/213=5/0`; `214/215=5/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 5 is 69. |
