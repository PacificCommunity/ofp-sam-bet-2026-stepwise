...
Allows linear and quadratic basis terms to vary across the three-year endpoint while flattening cubic and higher terms.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=50`; `202/203=3/3`; `210/211=3/3`; `212/213=3/3`; `214/215=3/3`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 3 is 71. |
...
1 202 3   1 203 3   1 210 3   1 211 3
1 212 3   1 213 3   1 214 3   1 215 3
```
