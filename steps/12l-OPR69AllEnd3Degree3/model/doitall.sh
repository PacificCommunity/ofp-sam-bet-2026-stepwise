...
# 12l OPR: three-year endpoint with linear and quadratic trends retained.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 155 69  # annual OPR coefficient count (polynomial degree = count - 1)
  1 217 1   # seasonal OPR coefficient count (polynomial degree = count - 1)
  1 216 50  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 50  # season-by-region OPR coefficient count (polynomial degree = count - 1)
  1 202 3   # year effect: last 3 real years share the high-order endpoint basis
  1 203 3   # year effect: linear and quadratic terms remain free; cubic and higher terms are flat
  1 210 3   # region effect: last 3 real years share the high-order endpoint basis
  1 211 3   # region effect: linear and quadratic terms remain free; cubic and higher terms are flat
  1 212 3   # season effect: last 3 real years share the high-order endpoint basis
  1 213 3   # season effect: linear and quadratic terms remain free; cubic and higher terms are flat
  1 214 3   # season-by-region effect: last 3 real years share the high-order endpoint basis
  1 215 3   # season-by-region effect: linear and quadratic terms remain free; cubic and higher terms are flat
