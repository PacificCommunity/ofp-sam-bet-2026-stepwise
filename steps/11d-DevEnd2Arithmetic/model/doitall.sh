...
# parest_flag(400) counts recruitment time periods (quarters here), not calendar years.
  1 400 2   # last 2 quarterly recruitment deviation(s) are fixed
  1 398 1   # replace those terminal recruitments with the arithmetic mean of earlier natural-scale recruits
