...
Tests the absolute 73-year saturation boundary with no multi-year endpoint tie in any OPR component. Reduces only the season-by-region block, isolating the main Hessian burden.
...
```text
1 155 73   1 217 1   1 216 50   1 218 40
