...
Tests the fully saturated annual basis conditional on a three-year endpoint in every OPR component. Uses the current Step 12 rank-1 component profile as the within-branch reference.
