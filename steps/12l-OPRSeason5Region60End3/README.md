...
OPR step-12 sensitivity `69-05-60-60 end3` before length-based selectivity.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/12l-OPRSeason5Region60End3/model` |
...
| 2 | Applies OPR sensitivity `69-05-60-60 end3`. |
...
| 3 | `1 155 69`, `1 217 5`, `1 216 60`, and `1 218 60` set the OPR year, season, region, and region-season effects. |
...
| 5 | The OPR transfer uses sensitivity `69-05-60-60 end3` with terminal end window `3`. |

## Checks

| # | Check |
| --- | --- |
| 1 | After fitting, compare terminal recruitment and likelihood diagnostics against 11-TimeVaryingCV and 12-OrthogonalPoly. |
