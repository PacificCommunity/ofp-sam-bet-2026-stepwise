...
Separates a near-saturated free annual effect from a two-year non-annual endpoint. Reduces only the season-by-region block, isolating the main Hessian burden.
