# 12p068-Benchmark-OPR69-E2-W100-FBase

Reproduces the supplied OPR69-01-50-50, two-calendar-year endpoint, terminal-penalty weight 100, and 1,000-evaluation protocol from a newly fitted branch-local 11.par. It is a numerical benchmark only; the curated candidate grid uses 73, 72, and 71 annual coefficients.

## Controls

- OPR profile: `69-01-50-50`; terminal window: 2 calendar year(s) = 8 quarters; component endpoint: `0`.
