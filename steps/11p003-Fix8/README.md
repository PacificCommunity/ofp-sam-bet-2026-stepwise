...
Uses ordinary quarter-specific recruitment deviations and fixes the last eight quarterly deviations to the historical arithmetic-mean treatment. The reviewed controls are propagated across shared selectivity groups so this is a source-consistent structural control for the OPR response.

## Controls

- Recruitment: ordinary quarterly deviations; final fixed block = 8 quarter(s).
- Arithmetic-mean terminal treatment: `true`.
