...
Apply the BASE075 composition-weighting alternative.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/09a-BASE075/model` |
...
| # | Change |
| --- | --- |
| 1 | Apply the BASE075 composition-weighting alternative. |
...
| `doitall.sh` | Apply the BASE075 composition-weighting alternative. | All previously selected controls; no OPR or length-bin selectivity. |
