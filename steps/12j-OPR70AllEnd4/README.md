...
Tests the annual saturation ceiling for 73 years with a four-year endpoint: 70 coefficients.
...
| Terminal treatment | `155=70`, `217=1`, `216=50`, `218=50`; `202/203=4/0`; `210/211=4/0`; `212/213=4/0`; `214/215=4/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 4 is 70. |
...
```text
1 155 70   1 217 1   1 216 50   1 218 50
1 202 4   1 203 0   1 210 4   1 211 0
