...
# 12j OPR: saturated annual effect conditional on a four-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 155 70  # annual OPR coefficient count (polynomial degree = count - 1)
  ...
  1 202 4   # year effect: last 4 real years share the high-order endpoint basis
