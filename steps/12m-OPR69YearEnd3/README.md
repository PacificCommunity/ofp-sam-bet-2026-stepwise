...
Identifies whether extending only the common annual recruitment signal removes the spike with less scale movement.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=50`; `202/203=3/0`; `210/211=2/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 3 is 71. |
...
1 202 3   1 203 0   1 210 2   1 211 0
