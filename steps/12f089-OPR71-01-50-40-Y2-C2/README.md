...
Tests 71 annual coefficients under the same two-year endpoint as the saturated 72/end2 case. Reduces only the season-by-region block, isolating the main Hessian burden.
