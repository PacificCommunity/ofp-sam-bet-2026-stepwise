# 15b Sub-basin age weighting selected

Apply the exact heterogeneous SUB075 composition weighting; this sibling is selected.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/15b-SUB075/model` |
...
| # | Change |
| --- | --- |
| 1 | Apply the exact heterogeneous SUB075 composition weighting; this sibling is selected. |
| 2 | Scientific parent: '14-NewAgeData'. |
...
| `Step-specific change` | Apply the exact heterogeneous SUB075 composition weighting; this sibling is selected. | All previously selected controls; no OPR or length-bin selectivity. |
