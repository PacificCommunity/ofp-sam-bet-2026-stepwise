...
Tests the absolute 73-year saturation boundary with no multi-year endpoint tie in any OPR component. Reduces only the regional block, isolating it from the season-by-region interaction.
...
```text
1 155 73   1 217 1   1 216 40   1 218 50
