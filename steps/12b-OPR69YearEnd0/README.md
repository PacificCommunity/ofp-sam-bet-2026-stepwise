...
Separates the annual terminal tie from the existing two-year regional, seasonal, and season-by-region endpoint ties.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=50`; `202/203=0/0`; `210/211=2/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 0 is 73 (MFCL normalizes zero to a one-point, unpooled endpoint). |
