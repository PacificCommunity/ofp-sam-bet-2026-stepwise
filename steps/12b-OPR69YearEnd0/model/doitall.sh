...
# 12b OPR: annual endpoint disabled, non-annual endpoints retained at two years.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 210 2   # region effect: last 2 real years share the high-order endpoint basis
  1 211 0   # region effect: all non-constant terms are flat in its end window
  1 212 2   # season effect: last 2 real years share the high-order endpoint basis
  1 213 0   # season effect: all non-constant terms are flat in its end window
  1 214 2   # season-by-region effect: last 2 real years share the high-order endpoint basis
