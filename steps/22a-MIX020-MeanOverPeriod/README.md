...
| Target method | Mean over period |
| Target mixing-period source | `PacificCommunity/ofp-sam-2026-BET-YFT-build-ini`, branch `main` |
| Target source commit | `d48e39617217c7156c5859a9b6c1b78a840306fa` |
...
Step 21; no other section of the main-branch INI is imported.

## Purpose

This isolates the K=0.2 mean-over-period mixing assignment from the Step 21
K=0.15 state.
