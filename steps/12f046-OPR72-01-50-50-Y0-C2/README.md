...
Separates a near-saturated free annual effect from a two-year non-annual endpoint. Uses the current Step 12 rank-1 component profile as the within-branch reference.
