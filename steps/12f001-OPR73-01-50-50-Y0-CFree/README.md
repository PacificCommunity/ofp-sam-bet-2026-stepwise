...
Tests the absolute 73-year saturation boundary with no multi-year endpoint tie in any OPR component. Uses the current Step 12 rank-1 component profile as the within-branch reference.
...
```text
1 155 73   1 217 1   1 216 50   1 218 50
