...
Tests the absolute 73-year saturation boundary with no multi-year endpoint tie in any OPR component. Combines the seasonal-5 alternative with the higher spatial-complexity screen.
...
```text
1 155 73   1 217 5   1 216 60   1 218 60
