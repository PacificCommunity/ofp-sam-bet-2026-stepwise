...
# 12cf OPR: seasonal 05 with low regional and interaction blocks and three-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 216 10  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 10  # season-by-region OPR coefficient count (polynomial degree = count - 1)
