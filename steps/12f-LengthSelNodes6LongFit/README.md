...
| Field | Value |
| --- | --- |
| Step folder | `steps/12f-LengthSelNodes6LongFit/model` |
...
| Setting | Value |
| --- | --- |
| Variant | Length-based selectivity nodes 6 long fit |
| Cubic spline nodes | 6 |
| Fit schedule | PHASE 10/11 max evaluations doubled to 20000/10000 |
