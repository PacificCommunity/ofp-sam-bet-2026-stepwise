...
Keeps the fully saturated annual effect free while testing a four-year non-annual endpoint treatment. Reduces only the season-by-region block, isolating the main Hessian burden.
