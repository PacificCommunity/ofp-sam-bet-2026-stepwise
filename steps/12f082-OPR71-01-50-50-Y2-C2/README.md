...
Tests 71 annual coefficients under the same two-year endpoint as the saturated 72/end2 case. Uses the current Step 12 rank-1 component profile as the within-branch reference.
