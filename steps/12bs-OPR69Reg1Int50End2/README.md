...
Separates a near-minimal regional temporal basis from the baseline season-by-region interaction basis.
...
| Terminal treatment | `155=69`, `217=1`, `216=1`, `218=50`; `202/203=2/0`; `210/211=2/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 2 is 72. |
