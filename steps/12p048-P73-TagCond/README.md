...
Uses parest_flag(249)=1 so tag information is conditioned on total recaptures and primarily informs their relative distribution. It is an alternative observation model, not an automatic preferred case.
