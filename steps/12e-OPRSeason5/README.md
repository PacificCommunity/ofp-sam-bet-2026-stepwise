...
OPR step-12 sensitivity `69-05-50-50` before length-based selectivity.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/12e-OPRSeason5/model` |
...
| 2 | Applies OPR sensitivity `69-05-50-50`. |
...
| 5 | The OPR transfer uses sensitivity `69-05-50-50` with terminal end window `2`. |
