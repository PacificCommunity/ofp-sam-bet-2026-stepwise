...
Provides a lower near-saturated comparison with no multi-year endpoint treatment. Reduces only the season-by-region block, isolating the main Hessian burden.
...
```text
1 155 71   1 217 1   1 216 50   1 218 40
