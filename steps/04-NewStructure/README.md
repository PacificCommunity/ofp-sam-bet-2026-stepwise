...
| `.ini` | Applies the fixed Lorenzen natural-mortality coefficients, normalizes the tag-flags marker, and uses bias-corrected BET 2026 L-W parameters a=3.073533e-05, b=2.932410. Grouped tag reporting-rate initial values are harmonized for native MFCL without changing group flags, targets, or penalties. | `LN(R0)=17`, bias-corrected L-W, tag grouping, and `tag_flags(it,2)=0`. |
...
| # | Control |
| --- | --- |
| 1 | This step is the 5-region control template for steps 05-17. |
