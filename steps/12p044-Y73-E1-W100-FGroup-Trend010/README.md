# 12p044-Y73-E1-W100-FGroup-Trend010

Separates the OPR trend penalty from the terminal-mean penalty with parest_flag(153)=1 (weight 0.1).
...
- OPR trend flag: `parest_flag(153)=1`.
