...
Tests the fully saturated annual basis conditional on a two-year endpoint in every OPR component. Reduces only the season-by-region block, isolating the main Hessian burden.
