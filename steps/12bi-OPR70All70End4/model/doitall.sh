...
# 12bi OPR: all effects saturated conditional on four-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 217 70   # seasonal OPR coefficient count (polynomial degree = count - 1)
  1 216 70  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 70  # season-by-region OPR coefficient count (polynomial degree = count - 1)
