...
Tests the all-effect saturation ceiling under a four-year endpoint.
...
| Terminal treatment | `155=70`, `217=70`, `216=70`, `218=70`; `202/203=4/0`; `210/211=4/0`; `212/213=4/0`; `214/215=4/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 4 is 70. |
...
```text
1 155 70   1 217 70   1 216 70   1 218 70
