...
Tests the absolute 73-year saturation boundary with no multi-year endpoint tie in any OPR component. Combines the seasonal-5 alternative with a balanced spatial reduction.
...
```text
1 155 73   1 217 5   1 216 40   1 218 40
