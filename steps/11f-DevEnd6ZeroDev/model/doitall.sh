...
# parest_flag(400) counts recruitment time periods (quarters here), not calendar years.
  1 400 6   # last 6 quarterly recruitment deviation(s) are fixed
  1 398 0   # retain fixed terminal deviations at zero; do not apply the arithmetic-mean replacement
