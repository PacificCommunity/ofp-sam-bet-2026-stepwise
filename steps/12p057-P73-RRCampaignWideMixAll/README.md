# 12p057-P73-RRCampaignWideMixAll

Combines all-release pre-mixing correction with the same 0.52015 campaign target but relaxes the reporting-rate penalty to 48.52 (prior SD about 0.10). This is a prior-conflict diagnostic, not a preferred fit selected by recruitment shape.
...
- Tag-release deletion: `none`; 2021 reporting-rate scope: `campaign`; target 0.52015; penalty 48.52.
