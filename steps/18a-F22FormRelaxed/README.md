...
Retain the Step 17b model and remove the dome/old-age-tail selectivity-form penalty for F22 only.
...
| # | Change |
| --- | --- |
| 1 | Retain the Step 17b model and remove the dome/old-age-tail selectivity-form penalty for F22 only. |
...
| `doitall.sh` | Retain the Step 17b model and remove the dome/old-age-tail selectivity-form penalty for F22 only. | All previously selected controls; no OPR or length-bin selectivity. |
