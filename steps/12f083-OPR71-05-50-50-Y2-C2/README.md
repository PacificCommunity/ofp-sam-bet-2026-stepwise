...
Tests 71 annual coefficients under the same two-year endpoint as the saturated 72/end2 case. Adds seasonal flexibility while holding both spatial blocks at the Step 12 values.
