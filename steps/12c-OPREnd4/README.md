...
OPR step-12 sensitivity `69-01-50-50 end4` before length-based selectivity.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/12c-OPREnd4/model` |
...
| 2 | Applies OPR sensitivity `69-01-50-50 end4`. |
...
| 5 | The OPR transfer uses sensitivity `69-01-50-50 end4` with terminal end window `4`. |
