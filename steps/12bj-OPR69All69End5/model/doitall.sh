...
# 12bj OPR: all effects saturated conditional on five-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 217 69   # seasonal OPR coefficient count (polynomial degree = count - 1)
  ...
  1 202 5   # year effect: last 5 real years share the high-order endpoint basis
  1 203 0   # year effect: all non-constant terms are flat in its end window
  1 210 5   # region effect: last 5 real years share the high-order endpoint basis
  1 211 0   # region effect: all non-constant terms are flat in its end window
  1 212 5   # season effect: last 5 real years share the high-order endpoint basis
  1 213 0   # season effect: all non-constant terms are flat in its end window
  1 214 5   # season-by-region effect: last 5 real years share the high-order endpoint basis
