...
Retain the Step 17b model and remove the dome/old-age-tail selectivity-form penalty for F15 and F22 only.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/18c-F15F22FormRelaxed/model` |
...
| # | Change |
| --- | --- |
| 1 | Retain the Step 17b model and remove the dome/old-age-tail selectivity-form penalty for F15 and F22 only. |
...
| `doitall.sh` | Retain the Step 17b model and remove the dome/old-age-tail selectivity-form penalty for F15 and F22 only. | All previously selected controls; no OPR or length-bin selectivity. |
