...
# SELECTIVITY-FORM SENSITIVITY: remove the F15 and F22 dome/old-age-tail penalty penalties.
  -15 16 0  # F15 HL.PH.2: no dome/old-age-tail selectivity-form penalty
  -22 16 0  # F22 DOM.PH.2: no dome/old-age-tail selectivity-form penalty
PHASE1
