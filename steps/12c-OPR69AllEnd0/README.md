...
Tests whether removing all multi-year endpoint pooling, rather than the annual endpoint alone, changes the terminal spike.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=50`; `202/203=0/0`; `210/211=-1/0`; `212/213=-1/0`; `214/215=-1/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 0 is 73 (MFCL normalizes zero to a one-point, unpooled endpoint). |
