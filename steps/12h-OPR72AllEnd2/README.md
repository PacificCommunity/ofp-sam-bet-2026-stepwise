...
Tests the annual saturation ceiling for 73 years with a two-year endpoint: 72 coefficients.
...
| Terminal treatment | `155=72`, `217=1`, `216=50`, `218=50`; `202/203=2/0`; `210/211=2/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 2 is 72. |
