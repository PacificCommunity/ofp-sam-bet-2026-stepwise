...
Tests one fewer annual coefficient than full saturation with all OPR components terminally free. Adds seasonal flexibility while holding both spatial blocks at the Step 12 values.
...
```text
1 155 72   1 217 5   1 216 50   1 218 50
