...
Uses parest_flag(249)=1 so tag data primarily inform relative spatial/fishery recapture patterns rather than absolute recapture magnitude and temporal mortality. This is a different observation model, not an automatic preferred case.
...
- Tag observation model: `recaptures_conditioned`; estimate pooled dispersion: `false`.
