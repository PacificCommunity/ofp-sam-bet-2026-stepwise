# 12p060-P73-TagMix60Q4

Sets tag_flags(60,2)=1 and the dominant 2021 release mixing period to 4 quarters. This brackets plausible pre-mixing duration without suppressing later recaptures.
...
- Mixing-period reporting treatment: `group60`; dominant 2021 mixing period override: `4 quarters`.
