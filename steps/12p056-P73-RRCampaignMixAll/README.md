# 12p056-P73-RRCampaignMixAll

Combines the externally informed 2021 campaign reporting-rate parameter (target 0.52015, penalty 485.2) with tag_flags(:,2)=1. It is shortlisted only if likelihood components, population scale, gradients, and Hessian diagnostics remain stable at stricter convergence.
