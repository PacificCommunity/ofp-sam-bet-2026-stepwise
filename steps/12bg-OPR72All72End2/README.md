...
Tests the all-effect saturation ceiling under a two-year endpoint; 72 is the MFCL-valid maximum coefficient count for each effect.
...
| Terminal treatment | `155=72`, `217=72`, `216=72`, `218=72`; `202/203=2/0`; `210/211=2/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 2 is 72. |
...
```text
1 155 72   1 217 72   1 216 72   1 218 72
