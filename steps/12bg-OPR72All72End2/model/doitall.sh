...
# 12bg OPR: all effects saturated conditional on two-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 217 72   # seasonal OPR coefficient count (polynomial degree = count - 1)
  1 216 72  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 72  # season-by-region OPR coefficient count (polynomial degree = count - 1)
