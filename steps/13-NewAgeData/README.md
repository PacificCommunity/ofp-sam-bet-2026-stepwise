...
| Field | Value |
| --- | --- |
| Step folder | `steps/13-NewAgeData/model` |
...
| # | Change |
| --- | --- |
| 1 | Add the new CAAL data with weighting factor 0.75. |
...
| 6 | Scientific parent: '12-CPUEErrorCalibration'. |
...
| `Step-specific change` | Add the new CAAL data with weighting factor 0.75. | All previously selected controls; no OPR or length-bin selectivity. |
