...
| Field | Value |
| --- | --- |
| Step folder | `steps/16-DOMDiv200/model` |
...
| # | Change |
| --- | --- |
| 1 | Apply the assessment-specific DOM divisor 200 only to F21-F23. |
| 2 | Scientific parent: '15-SelectivityUpdate'. |
...
| `doitall.sh` | Apply the assessment-specific DOM divisor 200 only to F21-F23. | All previously selected controls; no OPR or length-bin selectivity. |
