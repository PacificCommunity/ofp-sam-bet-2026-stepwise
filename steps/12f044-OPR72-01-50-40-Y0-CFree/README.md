...
Tests one fewer annual coefficient than full saturation with all OPR components terminally free. Reduces only the season-by-region block, isolating the main Hessian burden.
...
```text
1 155 72   1 217 1   1 216 50   1 218 40
