...
Uses the binned-gamma likelihood with a one-recapture censor and one estimated dispersion parameter to represent excess zero/small cells. Likelihood values cannot be compared directly with negative-binomial cases.
...
- Tag observation model: `binned_gamma`; estimate pooled dispersion: `true`.
