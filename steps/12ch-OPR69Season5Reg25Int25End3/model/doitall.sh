...
# 12ch OPR: seasonal 05 with mid-low regional and interaction blocks and three-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 216 25  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 25  # season-by-region OPR coefficient count (polynomial degree = count - 1)
