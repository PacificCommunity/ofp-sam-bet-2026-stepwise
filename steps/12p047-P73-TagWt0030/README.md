# 12p047-P73-TagWt0030

Scales only the tag likelihood to 0.03 with parest_flag(177)=30 while retaining reporting-rate priors. The three-point response tests whether the recent recruitment signal changes continuously with tag influence.
