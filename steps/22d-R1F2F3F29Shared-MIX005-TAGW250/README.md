...
Retain the K=0.05 grouped-selectivity final DM model and set parest flag 177 to 250, multiplying the tag-return likelihood by 0.25.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/22d-R1F2F3F29Shared-MIX005-TAGW250/model` |
...
| # | Change |
| --- | --- |
| 1 | Retain the K=0.05 grouped-selectivity final DM model and set parest flag 177 to 250, multiplying the tag-return likelihood by 0.25. |
...
| `Step-specific change` | Retain the K=0.05 grouped-selectivity final DM model and set parest flag 177 to 250, multiplying the tag-return likelihood by 0.25. | All previously selected controls; no OPR or length-bin selectivity. |
