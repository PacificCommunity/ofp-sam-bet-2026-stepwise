...
Tests the fully saturated annual basis conditional on a two-year endpoint in every OPR component. Combines the seasonal-5 alternative with a balanced spatial reduction.
