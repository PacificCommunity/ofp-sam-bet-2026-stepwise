...
Apply the BET 2026 72-01-50-50 orthogonal-polynomial recruitment structure while retaining the F33 asymptotic selectivity and one common tag-overdispersion parameter.
...
| # | Change |
| --- | --- |
| 1 | Apply the BET 2026 72-01-50-50 orthogonal-polynomial recruitment structure while retaining the F33 asymptotic selectivity and one common tag-overdispersion parameter. |
...
| `Step-specific change` | Apply the BET 2026 72-01-50-50 orthogonal-polynomial recruitment structure while retaining the F33 asymptotic selectivity and one common tag-overdispersion parameter. | All previously selected controls; no OPR or length-bin selectivity. |
...
| 13 | OPR uses the BET 2026 72-01-50-50 orthogonal-polynomial recruitment structure with a two-real-year end window. |
