...
Tests a high-complexity OPR envelope while retaining a valid two-year endpoint-constrained basis.
...
| Terminal treatment | `155=69`, `217=69`, `216=69`, `218=69`; `202/203=2/0`; `210/211=2/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 2 is 72. |
