...
| Field | Value |
| --- | --- |
| Step folder | `steps/18-EffortCreep/model` |
...
| # | Change |
| --- | --- |
| 1 | Apply the BET 2026 effort-creep series only to positive F29-F33 effort. |
...
| 6 | Scientific parent: '17-TagReportingExclusion'. |
...
| `Step-specific change` | Apply the BET 2026 effort-creep series only to positive F29-F33 effort. | All previously selected controls; no OPR or length-bin selectivity. |
