...
| Field | Value |
| --- | --- |
| Step folder | `steps/12b-LengthSelNodes4/model` |
...
| Setting | Value |
| --- | --- |
| Variant | Length-based selectivity nodes 4 |
| Cubic spline nodes | 4 |
| Fit schedule | PHASE 10/11 max evaluations unchanged at 10000/5000 |
