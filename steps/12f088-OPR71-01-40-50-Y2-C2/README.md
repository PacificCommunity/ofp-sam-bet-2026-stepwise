...
Tests 71 annual coefficients under the same two-year endpoint as the saturated 72/end2 case. Reduces only the regional block, isolating it from the season-by-region interaction.
