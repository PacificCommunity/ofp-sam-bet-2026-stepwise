...
Tests the absolute 73-year saturation boundary with no multi-year endpoint tie in any OPR component. Provides an intermediate seasonal count between the rank-1 and seasonal-5 screens.
...
```text
1 155 73   1 217 3   1 216 50   1 218 50
