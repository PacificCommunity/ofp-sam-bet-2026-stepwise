...
| Field | Value |
| --- | --- |
| Step folder | `steps/09c-SUB075/model` |
...
| 2 | Scientific parent: '08-RegionalCPUE'. |
...
| `doitall.sh` | Apply the exact heterogeneous SUB075 composition weighting; this sibling is selected. | All previously selected controls; no OPR or length-bin selectivity. |
