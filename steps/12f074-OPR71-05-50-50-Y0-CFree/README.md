...
Provides a lower near-saturated comparison with no multi-year endpoint treatment. Adds seasonal flexibility while holding both spatial blocks at the Step 12 values.
...
```text
1 155 71   1 217 5   1 216 50   1 218 50
