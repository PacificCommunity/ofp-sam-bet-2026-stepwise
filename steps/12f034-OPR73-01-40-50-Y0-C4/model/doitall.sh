...
# 12f034 OPR 73-01-40-50; annual end0; component end4.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 210 4   # region effect: last 4 real years share the high-order endpoint basis
  1 211 0   # region effect: all non-constant terms are flat in its end window
  1 212 4   # season effect: last 4 real years share the high-order endpoint basis
  1 213 0   # season effect: all non-constant terms are flat in its end window
  1 214 4   # season-by-region effect: last 4 real years share the high-order endpoint basis
