...
Keeps the fully saturated annual effect free while testing a four-year non-annual endpoint treatment. Reduces only the regional block, isolating it from the season-by-region interaction.
