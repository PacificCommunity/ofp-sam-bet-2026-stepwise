...
Identifies whether the large season-by-region OPR temporal basis drives the terminal behavior.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=50`; `202/203=2/0`; `210/211=2/0`; `212/213=2/0`; `214/215=3/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 2 is 72. |
...
1 212 2   1 213 0   1 214 3   1 215 0
```
