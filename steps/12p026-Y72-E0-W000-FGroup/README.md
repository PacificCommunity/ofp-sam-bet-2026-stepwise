# 12p026-Y72-E0-W000-FGroup

Uses 72 annual OPR coefficients with no annual terminal endpoint and component endpoint flags set to -1. This is the direct no-endpoint control; the terminal-recruitment penalty is necessarily off.

## Controls

- OPR profile: `72-01-50-50`; terminal window: no multi-year annual endpoint; component endpoint: `-1`.
