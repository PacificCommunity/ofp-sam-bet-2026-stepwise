...
Tests one fewer annual coefficient than full saturation with all OPR components terminally free. Uses the current Step 12 rank-1 component profile as the within-branch reference.
