...
Provides a lower near-saturated comparison with no multi-year endpoint treatment. Raises both spatial OPR blocks together to test whether added spatial flexibility absorbs the terminal signal.
...
```text
1 155 71   1 217 1   1 216 60   1 218 60
