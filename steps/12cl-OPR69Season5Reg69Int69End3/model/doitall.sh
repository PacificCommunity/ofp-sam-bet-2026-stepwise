...
# 12cl OPR: seasonal 05 with near-saturated regional and interaction blocks and three-year endpoint.
...
# The ordinary recruitment-deviation terminal controls below are disabled before OPR is activated.
  ...
  1 216 69  # regional OPR coefficient count (polynomial degree = count - 1)
  1 218 69  # season-by-region OPR coefficient count (polynomial degree = count - 1)
