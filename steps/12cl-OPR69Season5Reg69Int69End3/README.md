...
Tests the high regional-complexity seasonal-05 envelope under endpoint pooling.
...
| Terminal treatment | `155=69`, `217=5`, `216=69`, `218=69`; `202/203=3/0`; `210/211=3/0`; `212/213=3/0`; `214/215=3/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 3 is 71. |
...
```text
1 155 69   1 217 5   1 216 69   1 218 69
