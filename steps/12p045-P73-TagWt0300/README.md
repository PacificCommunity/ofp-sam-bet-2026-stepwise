# 12p045-P73-TagWt0300

Scales only the tag likelihood to 0.30 with parest_flag(177)=300 while retaining reporting-rate priors. The three-point response tests whether the recent recruitment signal changes continuously with tag influence.
...
- Tag likelihood scalar flag: `parest_flag(177)=300`.
