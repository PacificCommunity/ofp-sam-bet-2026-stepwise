...
Separates a near-saturated free annual effect from a two-year non-annual endpoint. Raises both spatial OPR blocks together to test whether added spatial flexibility absorbs the terminal signal.
