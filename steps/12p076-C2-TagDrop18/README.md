...
- Tag-release deletion: `group18`; 2021 reporting-rate scope: `shared`.
...
> The deletion case removes `group18` and starts from a fresh `-makepar`. TAG, FRQ, all seven MFCL 1007 tag controls, the pooled reporting row, and `tag_rep_map.R` are patched together.
