...
Tests the combined high-flexibility setting with the longer endpoint treatment.
...
| Terminal treatment | `155=69`, `217=5`, `216=60`, `218=60`; `202/203=4/0`; `210/211=4/0`; `212/213=4/0`; `214/215=4/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 4 is 70. |
...
```text
1 155 69   1 217 5   1 216 60   1 218 60
