...
Tests the absolute 73-year saturation boundary with no multi-year endpoint tie in any OPR component. Raises both spatial OPR blocks together to test whether added spatial flexibility absorbs the terminal signal.
...
| Terminal treatment | `155=73`, `217=1`, `216=60`, `218=60`; `202/203=0/0`; `210/211=-1/0`; `212/213=-1/0`; `214/215=-1/0`. With 73 real years and the effective one-point beginning endpoint, MFCL's annual coefficient ceiling is `74 - max(1, end window)`: end window 0 therefore permits at most 73 coefficients because MFCL normalises end0 to a one-point endpoint. A count of 74 is invalid even with end0. |
...
```text
1 155 73   1 217 1   1 216 60   1 218 60
1 202 0   1 203 0   1 210 -1   1 211 0
1 212 -1   1 213 0   1 214 -1   1 215 0
```
