...
Identifies whether the regional OPR temporal basis, rather than the annual basis, drives the terminal behavior.
...
| Terminal treatment | `155=69`, `217=1`, `216=50`, `218=50`; `202/203=2/0`; `210/211=3/0`; `212/213=2/0`; `214/215=2/0`. With 73 real years and the default one-point initial endpoint, the annual coefficient ceiling for end window 2 is 72. |
...
1 202 2   1 203 0   1 210 3   1 211 0
