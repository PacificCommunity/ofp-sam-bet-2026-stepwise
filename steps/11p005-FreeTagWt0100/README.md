# 11p005-FreeTagWt0100

Uses ordinary quarter-specific recruitment deviations and estimates every terminal deviation with tag likelihood weight 0.1. The reviewed controls are propagated across shared selectivity groups so this is a source-consistent structural control for the OPR response.
