...
Provides a lower near-saturated comparison with no multi-year endpoint treatment. Reduces both spatial OPR blocks together to test Hessian conditioning and fit loss.
...
```text
1 155 71   1 217 1   1 216 40   1 218 40
