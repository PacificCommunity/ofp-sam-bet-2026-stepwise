# 14b Sub-basin CAAL reweighting

Apply the selected CAAL reweighting with regions 3 and 4 combined.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/14b-SUB075/model` |
...
| # | Change |
| --- | --- |
| 1 | Apply the selected CAAL reweighting with regions 3 and 4 combined. |
...
| `Step-specific change` | Apply the selected CAAL reweighting with regions 3 and 4 combined. | All previously selected controls; no OPR or length-bin selectivity. |
