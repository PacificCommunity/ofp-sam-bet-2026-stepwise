...
Provides a lower near-saturated comparison with no multi-year endpoint treatment. Provides an intermediate seasonal count between the rank-1 and seasonal-5 screens.
...
```text
1 155 71   1 217 3   1 216 50   1 218 50
