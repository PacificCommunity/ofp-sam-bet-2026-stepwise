...
OPR step-12 sensitivity `69-01-50-50 end5` before length-based selectivity.

## Snapshot

| Field | Value |
| --- | --- |
| Step folder | `steps/12d-OPREnd5/model` |
...
| 2 | Applies OPR sensitivity `69-01-50-50 end5`. |
...
| 5 | The OPR transfer uses sensitivity `69-01-50-50 end5` with terminal end window `5`. |
