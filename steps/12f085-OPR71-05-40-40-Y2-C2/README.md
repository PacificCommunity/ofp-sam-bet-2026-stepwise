...
Tests 71 annual coefficients under the same two-year endpoint as the saturated 72/end2 case. Combines the seasonal-5 alternative with a balanced spatial reduction.
