...
# Job 18718 flexible selectivity: F1-F28 are independent; F29-F33 separate in staged run 5.
  ...
  -2 24 2  # F2 Step 15 flexible selectivity group
  -3 24 3  # F3 Step 15 flexible selectivity group
  -4 24 4  # F4 Step 15 flexible selectivity group
  -5 24 5  # F5 Step 15 flexible selectivity group
  -6 24 6  # F6 Step 15 flexible selectivity group
  -7 24 7  # F7 Step 15 flexible selectivity group
  -8 24 8  # F8 Step 15 flexible selectivity group
  -9 24 9  # F9 Step 15 flexible selectivity group
  -10 24 10  # F10 Step 15 flexible selectivity group
  -11 24 11  # F11 Step 15 flexible selectivity group
  -12 24 12  # F12 Step 15 flexible selectivity group
  -13 24 13  # F13 Step 15 flexible selectivity group
  -14 24 14  # F14 Step 15 flexible selectivity group
  -15 24 15  # F15 Step 15 flexible selectivity group
  -16 24 16  # F16 Step 15 flexible selectivity group
  -17 24 17  # F17 Step 15 flexible selectivity group
  -18 24 18  # F18 Step 15 flexible selectivity group
  -19 24 19  # F19 Step 15 flexible selectivity group
  -20 24 20  # F20 Step 15 flexible selectivity group
  -21 24 21  # F21 Step 15 flexible selectivity group
  -22 24 22  # F22 Step 15 flexible selectivity group
  -23 24 23  # F23 Step 15 flexible selectivity group
  -24 24 24  # F24 Step 15 flexible selectivity group
  -25 24 25  # F25 Step 15 flexible selectivity group
  -26 24 26  # F26 Step 15 flexible selectivity group
  -27 24 27  # F27 Step 15 flexible selectivity group
  -28 24 28  # F28 Step 15 flexible selectivity group
  -29 24 29  # F29 Step 15 flexible selectivity group
  -30 24 29  # F30 Step 15 flexible selectivity group
  -31 24 29  # F31 Step 15 flexible selectivity group
  -32 24 29  # F32 Step 15 flexible selectivity group
  -33 24 29  # F33 Step 15 flexible selectivity group
...
# STAGED MFCL RUN 5: complete the Job 18718 flexible selectivity grouping.
  -29 24 29  # Index R1; separate flexible selectivity group from staged run 5
  -30 24 30  # Index R2; separate flexible selectivity group from staged run 5
  -31 24 31  # Index R3; separate flexible selectivity group from staged run 5
  -32 24 32  # Index R4; separate flexible selectivity group from staged run 5
  -33 24 33  # Index R5; separate flexible selectivity group from staged run 5
PHASE5
