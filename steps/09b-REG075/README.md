...
| Field | Value |
| --- | --- |
| Step folder | `steps/09b-REG075/model` |
...
| `doitall.sh` | Apply the exact heterogeneous REG075 composition-weighting alternative. | All previously selected controls; no OPR or length-bin selectivity. |
