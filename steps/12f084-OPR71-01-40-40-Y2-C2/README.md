...
Tests 71 annual coefficients under the same two-year endpoint as the saturated 72/end2 case. Reduces both spatial OPR blocks together to test Hessian conditioning and fit loss.
