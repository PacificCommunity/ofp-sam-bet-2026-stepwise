...
Tests 71 annual coefficients under the same two-year endpoint as the saturated 72/end2 case. Raises both spatial OPR blocks together to test whether added spatial flexibility absorbs the terminal signal.
