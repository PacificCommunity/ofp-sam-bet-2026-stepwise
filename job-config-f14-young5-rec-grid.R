...
## 72-01-50-50 OPR with the last-two-real-year end window).
...
stepwise_models <- data.frame(
  ...
  enabled = rep(TRUE, 8),
  major_step = rep("F14YoungAgeSensitivity", 8),
  substep = c(
    "Doitall-Rec01",
    "Doitall-Rec02",
  ...
  model_label = c(
    ...
    "03. F14 youngest 5 fixed | doitall | rec 0.1 | movement prior 0.2",
    "04. F14 youngest 5 fixed | doitall | rec 0.2 | movement prior 0.2",
    "05. F14 youngest 5 fixed | OPR 72-01-50-50 end2 | rec 0.1 | move 0.1",
    "06. F14 youngest 5 fixed | OPR 72-01-50-50 end2 | rec 0.2 | move 0.1",
    "07. F14 youngest 5 fixed | OPR 72-01-50-50 end2 | rec 0.1 | move 0.2",
    "08. F14 youngest 5 fixed | OPR 72-01-50-50 end2 | rec 0.2 | move 0.2"
  ),
  job_title = c(
    "01. F14 youngest-5 sensitivity | doitall | rec 0.1",
    "02. F14 youngest-5 sensitivity | doitall | rec 0.2",
    "03. F14 youngest-5 | doitall | rec 0.1 | move prior 0.2",
    "04. F14 youngest-5 | doitall | rec 0.2 | move prior 0.2",
    "05. F14 youngest-5 | OPR end2 | rec 0.1 | move 0.1",
    "06. F14 youngest-5 | OPR end2 | rec 0.2 | move 0.1",
    "07. F14 youngest-5 | OPR end2 | rec 0.1 | move 0.2",
    "08. F14 youngest-5 | OPR end2 | rec 0.2 | move 0.2"
  ),
  job_key = c(
    "f14-young5-doitall-rec01",
    "f14-young5-doitall-rec02",
    "f14-young5-doitall-rec01-move02",
    "f14-young5-doitall-rec02-move02",
    "f14-young5-doitall-rec01-opr-end2",
    "f14-young5-doitall-rec02-opr-end2",
    "f14-young5-doitall-rec01-move02-opr-end2",
    "f14-young5-doitall-rec02-move02-opr-end2"
  ),
  plot_order = 1:8,
