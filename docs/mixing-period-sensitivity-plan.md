...
| Mixing vector | `tag_flags(:,2)` fits | Release groups changed from Job 16594 | Counts of mixing values `0 / 1 / 2 / 3 / 4` |
|---|---:|---:|---:|
| SC22-IP10 `K=0.05` | `1`, `0` | 80 | `0 / 2 / 2 / 4 / 90` |
| SC22-IP10 `K=0.10` | `1`, `0` | 70 | `0 / 7 / 6 / 7 / 78` |
| SC22-IP10 `K=0.15` | `1`, `0` | 0 | `1 / 13 / 48 / 20 / 16` |
| SC22-IP10 `K=0.20` | `1`, `0` | 32 | `2 / 21 / 64 / 2 / 9` |
| SC22-IP10 `K=0.25` | `1`, `0` | 36 | `6 / 22 / 60 / 2 / 8` |
| SC22-IP10 `K=0.30` | `1`, `0` | 41 | `14 / 35 / 40 / 1 / 8` |
| SC22-IP10 `K=0.35` | `1`, `0` | 43 | `18 / 31 / 41 / 0 / 8` |
| SC22-IP10 `K=0.40` | `1`, `0` | 43 | `35 / 14 / 41 / 0 / 8` |
| SC22-IP10 `K=0.45` | `1`, `0` | 92 | `41 / 47 / 2 / 7 / 1` |
| All release groups `=2` | `1`, `0` | 50 | `0 / 0 / 98 / 0 / 0` |
