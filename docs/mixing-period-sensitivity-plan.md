...
| Mixing vector | RR treatment / exact setting | Release groups changed from Job 16594 | Counts of mixing values `0 / 1 / 2 / 3 / 4` |
|---|---:|---:|---:|
| SC22-IP10 `K=0.05` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 80 | `0 / 2 / 2 / 4 / 90` |
| SC22-IP10 `K=0.10` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 70 | `0 / 7 / 6 / 7 / 78` |
| SC22-IP10 `K=0.15` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 0 | `1 / 13 / 48 / 20 / 16` |
| SC22-IP10 `K=0.20` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 32 | `2 / 21 / 64 / 2 / 9` |
| SC22-IP10 `K=0.25` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 36 | `6 / 22 / 60 / 2 / 8` |
| SC22-IP10 `K=0.30` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 41 | `14 / 35 / 40 / 1 / 8` |
| SC22-IP10 `K=0.35` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 43 | `18 / 31 / 41 / 0 / 8` |
| SC22-IP10 `K=0.40` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 43 | `35 / 14 / 41 / 0 / 8` |
| SC22-IP10 `K=0.45` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 92 | `41 / 47 / 2 / 7 / 1` |
| All release groups `=2` | post-mix only (`tag2=1`) / all periods (`tag2=0`) | 50 | `0 / 0 / 98 / 0 / 0` |
