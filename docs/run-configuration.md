...
| --- | --- | --- |
| `01-Diag2023` | `steps/01-Diag2023/model` | `missing` |
| `02-NewExe1003` | `steps/02-NewExe1003/model` | `missing` |
| `03-Ini1007` | `steps/03-Ini1007/model` | `missing` |
| `04-FixM` | `steps/04-FixM/model` | `missing` |
| `05-LengthWeight` | `steps/05-LengthWeight/model` | `missing` |
| `06-NewStructure` | `steps/06-NewStructure/model` | `missing` |
| `07-ConvertToLength` | `steps/07-ConvertToLength/model` | `missing` |
| `08-AddLengthData` | `steps/08-AddLengthData/model` | `missing` |
| `09-TailCompression1Pct` | `steps/09-TailCompression1Pct/model` | `missing` |
| `10-DataTo2024` | `steps/10-DataTo2024/model` | `missing` |
| `11-RegionalCPUE` | `steps/11-RegionalCPUE/model` | `missing` |
| `12-TimeVaryingCV` | `steps/12-TimeVaryingCV/model` | `missing` |
| `13-CPUEErrorCalibration` | `steps/13-CPUEErrorCalibration/model` | `missing` |
| `14-NewAgeData` | `steps/14-NewAgeData/model` | `missing` |
| `15a-REG075` | `steps/15a-REG075/model` | `missing` |
| `15b-SUB075` | `steps/15b-SUB075/model` | `missing` |
| `16-SelectivityUpdate` | `steps/16-SelectivityUpdate/model` | `missing` |
| `17-MIX015` | `steps/17-MIX015/model` | `missing` |
| `18-TagReportingExclusion` | `steps/18-TagReportingExclusion/model` | `missing` |
| `19-EffortCreep` | `steps/19-EffortCreep/model` | `missing` |
| `20a-DOMDiv200` | `steps/20a-DOMDiv200/model` | `missing` |
| `20b-Francis` | `steps/20b-Francis/model` | `missing` |
| `20c-DMG8Nmax25` | `steps/20c-DMG8Nmax25/model` | `missing` |
| `21a-R1F2F3F29Shared-MIX015` | `steps/21a-R1F2F3F29Shared-MIX015/model` | `missing` |
| `21b-R1F2F3F29Shared-MIX005` | `steps/21b-R1F2F3F29Shared-MIX005/model` | `missing` |
| `22a-R1F2F3F29Shared-MIX015-TAGW500` | `steps/22a-R1F2F3F29Shared-MIX015-TAGW500/model` | `missing` |
| `22b-R1F2F3F29Shared-MIX015-TAGW250` | `steps/22b-R1F2F3F29Shared-MIX015-TAGW250/model` | `missing` |
| `22c-R1F2F3F29Shared-MIX005-TAGW500` | `steps/22c-R1F2F3F29Shared-MIX005-TAGW500/model` | `missing` |
| `22d-R1F2F3F29Shared-MIX005-TAGW250` | `steps/22d-R1F2F3F29Shared-MIX005-TAGW250/model` | `missing` |
| `S01-SelectivityStability-MIX015` | `steps/S01-SelectivityStability-MIX015/model` | `missing` |
| `S02-F33Asymptotic-MIX015` | `steps/S02-F33Asymptotic-MIX015/model` | `missing` |
| `S03-CommonTagTau-MIX015` | `steps/S03-CommonTagTau-MIX015/model` | `missing` |
| `S04-CommonTagTauSpline-MIX015` | `steps/S04-CommonTagTauSpline-MIX015/model` | `missing` |
| `S05-CommonTagTauOPR-MIX015` | `steps/S05-CommonTagTauOPR-MIX015/model` | `missing` |
| `S06-CommonTagTauSplineOPR-MIX015` | `steps/S06-CommonTagTauSplineOPR-MIX015/model` | `missing` |
