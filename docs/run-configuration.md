...
| `02a-NewExe1003` | `FALSE` | 02-Executable | 02a | current MFCL executable with the 1003 ini | Current executable with ini 1003 | 02a Current executable with ini 1003 | `02a-newexe1003` | `doitall` | /home/mfcl/mfclo64 | `blank` | `bet.frq` | `blank` |
...
| `17a-Francis` | `FALSE` | 17-CompositionLikelihood | 17a | apply the Francis composition-data weighting comparison | Francis length-composition weighting | 17a Francis length-composition weighting | `17a-francis` | `doitall` | /home/mfcl/mfclo64 | `blank` | `bet.frq` | `blank` |
