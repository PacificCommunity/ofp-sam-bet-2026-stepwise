...
| `04-FixM` | `TRUE` | 04-FixM | 04 | fix the log-scale Lorenzen natural-mortality coefficient at -2.54930339768360 | Fixed Lorenzen M scaling | 04 Fixed Lorenzen M scaling | `04-fixm` | `doitall` | /home/mfcl/mfclo64 | `blank` | `bet.frq` | `blank` |
