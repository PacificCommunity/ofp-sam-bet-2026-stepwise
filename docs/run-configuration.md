...
| `15-SelectivityUpdate` | `TRUE` | 15-SelectivityUpdate | 15 | revise fishery-specific selectivity | Revised fishery selectivity | 15 Revised fishery-specific selectivity | `15-selectivity-update` | `doitall` | /home/mfcl/mfclo64 | `blank` | `bet.frq` | `blank` |
