...
| `05-NewStructure` | `TRUE` | 05-NewStructure | 05 | adopt the five-region, 33-fishery structure | Five-region structure | 05 Five-region, 33-fishery structure | `05-new-structure` | `doitall` | /home/mfcl/mfclo64 | `blank` | `bet.frq` | `blank` |
...
| `15-SelectivityUpdate` | `TRUE` | 15-SelectivityUpdate | 15 | revise fishery-specific selectivity | Parsimonious fishery selectivity | 15 Parsimonious fishery-specific selectivity | `15-selectivity-update` | `doitall` | /home/mfcl/mfclo64 | `blank` | `bet.frq` | `blank` |
