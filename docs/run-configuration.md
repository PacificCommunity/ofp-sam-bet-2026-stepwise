...
| `flow_group` | `bet-2026-final-stepwise-diagnostic-04aug` | Kflow group label used to connect stepwise, results, and report jobs. |
...
| `12-CPUEErrorCalibration` | `TRUE` | 12-CPUEErrorCalibration | 12 | fix regional CPUE log-scale observation-error SDs at their maximum-likelihood estimates | MLE-based regional CPUE SDs | 12 Fix regional CPUE SDs at MLE-based estimates | `12-cpue-error-sd` | `doitall` | /home/mfcl/mfclo64 | `blank` | `bet.frq` | `blank` |
...
| `16-MIX020` | `TRUE` | 16-TagMixing | 16 | apply release-group-specific tag-mixing periods estimated using a KS D-statistic cutoff of 0.20 | KS D-statistic tag mixing | 16 KS D-statistic cutoff 0.20 tag mixing | `16-mix020` | `doitall` | /home/mfcl/mfclo64 | `blank` | `bet.frq` | `blank` |
