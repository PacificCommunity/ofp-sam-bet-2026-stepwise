...
| `flow_group` | `bet-2026-stepwise-s2-fixed-job604` | Kflow group label used to connect stepwise, results, and report jobs. |
...
| `12-EffortCreep` | `TRUE` | 12-EffortCreep | 12a | effort creep with length-at-age variance s2 fixed to the job 604 final-par estimate | Effort creep, s2 fixed | 12 Effort creep, s2 fixed to job 604 | `12-effortcreep` | `doitall` | blank | `blank` | `bet.frq` | `blank` | 11.par |
